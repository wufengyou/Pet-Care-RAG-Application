...
GRAFANA_PASSWORD = "wufy1234" #os.getenv("GRAFANA_ADMIN_PASSWORD")

PG_HOST =os.getenv("POSTGRES_HOST")# '172.17.235.199'#
PG_DB = os.getenv("POSTGRES_DB")
PG_USER = os.getenv("POSTGRES_USER")
PG_PASSWORD = os.getenv("POSTGRES_PASSWORD")
PG_PORT = os.getenv("POSTGRES_PORT")
print(GRAFANA_URL,GRAFANA_USER,GRAFANA_PASSWORD)
print(PG_HOST,PG_DB,PG_USER,PG_PASSWORD,PG_PORT)
